        ...
        <div className="md:hidden relative overflow-hidden rounded-xl bg-primary/30 aspect-[16/10] flex flex-col justify-end p-6">
          ...
          <div className="relative z-20 space-y-3">
            ...
            <div className="flex gap-2">
              <Link href="/checkout" className="bg-primary text-accent-pink px-5 py-2.5 rounded-lg font-bold text-sm shadow-lg shadow-primary/20">
                Đặt Ngay
              </Link>
              <Link href="/cakes" className="bg-white/20 backdrop-blur-md text-white px-5 py-2.5 rounded-lg font-bold text-sm border border-white/30">
                Xem Mẫu Bánh
              </Link>
            </div>
          </div>
        ...
        <div className="hidden md:grid max-w-7xl mx-auto lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/checkout" className="bg-accent-pink text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg transition-all">
                Đặt Ngay
              </Link>
              <Link href="/cakes" className="bg-white border-2 border-primary px-8 py-4 rounded-xl font-bold text-lg hover:bg-primary/10 transition-all">
                Xem Mẫu Bánh
              </Link>
            </div>
          </div>
      ...
      <section className="py-2 md:py-16 bg-white">
        ...
        <div className="hidden md:block max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link href="/cakes" className="text-accent-pink font-bold flex items-center gap-2">
              Xem Tất Cả <span className="material-symbols-outlined">arrow_forward</span>
            </Link>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <Link href="/cakes" className="group cursor-pointer">
      ...
      <section className="py-6 md:py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6 md:mb-10">
            ...
            <Link href="/cakes" className="text-accent-pink text-sm font-semibold">
              Xem tất cả
            </Link>
          </div>
