...
export default function CakeDetail({ params }: { params: { slug: string } }) {
  const cake = getCakeBySlug(params.slug)
  ...
  if (!cake) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/cakes" className="text-accent-pink font-bold">Quay lại trang bánh</Link>
      </div>
    )
  }

  const relatedCakes = getRelatedCakes(params.slug, 4)
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8 pb-32 md:pb-8">
      ...
      <nav className="hidden md:flex items-center gap-2 text-sm text-slate-500 mb-8">
        ...
        <Link href="/cakes" className="hover:text-primary">Bánh Signature</Link>
        <span className="material-symbols-outlined text-xs">chevron_right</span>
        ...
        <div className="lg:col-span-5 space-y-6 md:space-y-8">
          ...
          <div className="hidden md:block space-y-3 pt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <Link href="/checkout" className="flex items-center justify-center gap-2 py-4 bg-slate-900 text-white font-bold rounded-xl hover:opacity-90">
                Đặt hàng ngay
              </Link>
            </div>
